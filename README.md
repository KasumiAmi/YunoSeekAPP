...
YunoSeek 是 [yunoseek.ownbangdream.asia](https://yunoseek.ownbangdream.asia) 自托管后端的 React Native 原生客户端，用于替代早期的 Capacitor WebView 壳方案。它将 6 位原创虚拟角色与 DeepSeek 风格的对话 UI 结合，提供流式响应、深度思考、联网搜索、图片识图、引继码同步、放送日程、知识库归档以及应用内 OTA / APK 自更新等完整功能。
...
- **6 位原创角色对话**　头像 / 立绘 / 主题色 / 声优资料完整内置，对话内可一键切换
...
- **亮 / 暗主题 + 4 语言本地化**　中文 / 英文 / 日文 / 韩文
- **edge-to-edge + adjustResize**　Android 15+ 沉浸式适配，键盘无挤压
